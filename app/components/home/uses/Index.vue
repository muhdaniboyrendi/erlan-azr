...
const accessoriesItems = ref([
  ...
  },
  {
    name: "UPLU Light Bar",
    brand: "UPLU",
    description: "Lightbar to add some ambiance to my workspace",
    icon: "💡",
  },
]);
</script>
          ...
          >
            <div class="flex flex-col gap-4 md:gap-6 bg-cyan-400/5 p-4 md:p-6">
              <div class="flex gap-4 md:gap-6">
                ...
                <div class="flex-1">
                  <div
                    class="flex items-start justify-end md:justify-between mb-2"
                  >
                  ...
                  <p class="text-gray-400 text-sm mb-4 hidden md:block">
                    {{ item.description }}
                  </p>
